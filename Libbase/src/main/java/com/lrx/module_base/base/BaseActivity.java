...
import com.lrx.module_base.baseUtil.ClassUtil;
import com.lrx.module_base.baseUtil.StatusBarUtil;
import com.lrx.module_base.databinding.ActivityBaseBinding;
...
public abstract class BaseActivity<VM extends AndroidViewModel, SV extends ViewDataBinding> extends AppCompatActivity {
    ...
    public void setContentView(@LayoutRes int layoutResID) {
        ...
        RelativeLayout mContainer = mBaseBinding.container;//(RelativeLayout) mBaseBinding.getRoot().findViewById(R.id.container);
